...
const preParsedPages: PreParsedPages = {
    ...
    info: {
        'coins-info': { title: 'Coins Info', icon: 'coin', description: 'Information about coins that have been and are produced in the United States' },
        'coins-list': { title: 'Coins List', icon: 'coins', description: 'A list of coins I have/need' },
        'euro-coins': { title: 'Euro Coins', icon: 'euro-sign', description: 'List of all euro coin designs', additionalData: { euroCoins } },
        'minecraft-codes': {
