...
async function loadCoinsList() {
    ...
    coins.forEach((coinType) => {
        ...
        coinTypeImg.src = `https://raw.githubusercontent.com/Eejit43/eejitstools-v2-files/main/files/coins/${coinType.id}/${coinType.coins[coinType.coins.length - 1]?.image || 'default'}.png`;
        ...
        coinType.coins.forEach((coinVariant) => {
            ...
            coinVariantImg.src = `https://raw.githubusercontent.com/Eejit43/eejitstools-v2-files/main/files/coins/${coinType.id}/${coinVariant.image || 'default'}.png`;
            ...
            coinVariant.coins.forEach((coin) => {
                ...
                if (coin.image) {
                    ...
                    image.dataset.image = `https://raw.githubusercontent.com/Eejit43/eejitstools-v2-files/main/files/coins/${coinType.id}/${coin.image}.png`;
                ...
                if (coin.comparison) {
                    ...
                    comparison.dataset.image = `https://raw.githubusercontent.com/Eejit43/eejitstools-v2-files/main/files/coins/${coinType.id}/${coin.comparison}.png`;
