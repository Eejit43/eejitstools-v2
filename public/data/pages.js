...
const allPageInfo = {
  ...
  info: [
    ...
    { title: "Queer Calendar", id: "queer-calendar", icon: "calendar-days", description: "Show LGBTQ+ related events for the current date or an inputted date of the current year", iconStyle: "color: #e73636", toolboxTitle: '<span style="color: #e78236">Q</span><span style="color: #e7ce36">u</span><span style="color: #b5e736">e</span><span style="color: #69e736">e</span><span style="color: #36e74f">r</span> <span style="color: #36e79b">C</span><span style="color: #36e7e7">a</span><span style="color: #369be7">l</span><span style="color: #364fe7">e</span><span style="color: #6936e7">n</span><span style="color: #b536e7">d</span><span style="color: #e736ce">a</span><span style="color: #e73682">r</span> \u{1F3F3}\uFE0F\u200D\u{1F308}' },
...
const pagesParsed = Object.fromEntries(
  Object.entries(allPageInfo).map(([category, pages]) => [
    ...
    Object.fromEntries(
      pages.map((page) => {
        ...
        if (!Object.hasOwn(page, "script"))
          delete result[1].script;
        if (!Object.hasOwn(page, "style"))
          delete result[1].style;
        return result;
      })
    )
  ])
...
const holidayEmojis = {
  ...
  "Martin Luther King Jr. Day": "\u{1F474}\u{1F3FE}",
  "First Day of Black History Month": "\u270A\u{1F3FF}",
  "Valentine's Day": "\u2764\uFE0F",
  "Presidents' Day": "\u{1F935}",
  "First Day of Women's History Month": "\u{1F469}",
  "St. Patrick's Day": "\u2618\uFE0F",
  "Daylight Saving Time starts": "\u{1F551}",
  "Easter Sunday": "\u{1F407}",
  "Tax Day": "\u{1F4B0}",
  "Easter Monday": "\u{1F407}",
  "First Day of Asian Pacific American Heritage Month": "\u{1F30F}",
  "Cinco de Mayo": "\u{1F973}",
  "Mother's Day": "\u{1F931}",
  "Memorial Day": "\u{1FAA6}",
  "First Day of LGBTQ+ Pride Month": "\u{1F3F3}\uFE0F\u200D\u{1F308}",
  "Flag Day": "\u{1F1FA}\u{1F1F8}",
  "Father's Day": "\u{1F468}",
  Juneteenth: "\u270A\u{1F3FF}",
  "Summer Solstice": "\u2600\uFE0F",
  "Independence Day": "\u{1F1FA}\u{1F1F8}",
  "Labor Day": "\u{1F6E0}",
  "First Day of Hispanic Heritage Month": "\u{1F30E}",
  "Indigenous Peoples' Day": "\u{1FAB6}",
  "Columbus Day": "\u26F5\uFE0F",
  Halloween: "\u{1F383}",
  "First Day of American Indian Heritage Month": "\u{1FAB6}",
  "Daylight Saving Time ends": "\u{1F551}",
  "Election Day": "\u{1F5F3}\uFE0F",
  "Veterans Day": "\u{1F396}\uFE0F",
  "Thanksgiving Day": "\u{1F983}",
  "Native American Heritage Day": "\u{1FAB6}",
  "Winter Solstice": "\u2744\uFE0F",
  "Christmas Eve": "\u{1F385}\u{1F3FB}",
  "Christmas Day": "\u{1F384}",
  "New Year's Eve": "\u{1F55B}"
};
const moonEmojis = {
  "New moon": "\u{1F311}",
